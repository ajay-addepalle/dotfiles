		...
		if step == false then
			sbar.exec(
				"sleep "
					.. animation_duration
					.. " && "
					.. " sketchybar --set mario background.image=/Users/aaddepalle/.config/sketchybar/imgs/r_stand_s"
					.. ".png  padding_left="
					.. lpad
			)
			--mario:set({
			...
			sbar.exec(
				"sleep "
					.. animation_duration
					.. " && "
					.. " sketchybar --set mario background.image=/Users/aaddepalle/.config/sketchybar/imgs/r_run_s"
					.. ".png padding_left="
					.. lpad
			)

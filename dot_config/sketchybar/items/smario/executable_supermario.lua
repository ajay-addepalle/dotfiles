	...
	if lpad <= rend then
		if step == false then
			mario:set({
				background = {
					image = {
						string = "/Users/aaddepalle/.config/sketchybar/imgs/r_stand_s.png",
					},
				},
				padding_left = lpad,
			})
			...
			mario:set({
				background = {
					image = {
						string = "/Users/aaddepalle/.config/sketchybar/imgs/r_run_s.png",
					},
				},
				padding_left = lpad,
			})
		...
		sbar.exec("sh /Users/aaddepalle/.config/sketchybar/items/go_right.sh")
	end
end

mario:subscribe("go_right", run_right)
